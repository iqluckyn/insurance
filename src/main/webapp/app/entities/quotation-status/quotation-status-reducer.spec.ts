...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUOTATIONSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUOTATIONSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUOTATIONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_QUOTATIONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_QUOTATIONSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUOTATIONSTATUS actions', async () => {
      const arg = 42666;
