          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('seasonName')}>
                  Season Name <FontAwesomeIcon icon={getSortIconByFieldName('seasonName')} />
                </th>
            ...
            <tbody>
              {seasonList.map((season, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{season.isActive ? 'true' : 'false'}</td>
                  <td>{season.cropType ? <Link to={`/crop-type/${season.cropType.id}`}>{season.cropType.id}</Link> : ''}</td>
