...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './crop-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CROPTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CROPTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CROPTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CROPTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CROPTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CROPTYPE actions', async () => {
      const arg = 42666;
