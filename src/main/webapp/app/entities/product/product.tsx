            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('productCode')}>
                  Product Code <FontAwesomeIcon icon={getSortIconByFieldName('productCode')} />
                </th>
                <th className="hand" onClick={sort('productDescription')}>
                  Product Description <FontAwesomeIcon icon={getSortIconByFieldName('productDescription')} />
                </th>
