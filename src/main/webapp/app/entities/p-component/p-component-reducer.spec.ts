...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PCOMPONENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PCOMPONENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PCOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PCOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PCOMPONENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PCOMPONENT actions', async () => {
      const arg = 42666;
