...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './business.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUSINESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUSINESS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BUSINESS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUSINESS actions', async () => {
      const arg = 42666;
