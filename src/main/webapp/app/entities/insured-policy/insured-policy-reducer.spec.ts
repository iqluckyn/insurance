...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSUREDPOLICY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSUREDPOLICY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSUREDPOLICY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSUREDPOLICY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSUREDPOLICY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSUREDPOLICY actions', async () => {
      const arg = 42666;
