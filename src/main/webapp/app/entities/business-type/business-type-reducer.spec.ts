...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUSINESSTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUSINESSTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BUSINESSTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUSINESSTYPE actions', async () => {
      const arg = 42666;
