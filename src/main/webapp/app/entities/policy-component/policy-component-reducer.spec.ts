...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLICYCOMPONENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POLICYCOMPONENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POLICYCOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POLICYCOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POLICYCOMPONENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POLICYCOMPONENT actions', async () => {
      const arg = 42666;
