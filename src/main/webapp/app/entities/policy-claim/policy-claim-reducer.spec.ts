...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLICYCLAIM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POLICYCLAIM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POLICYCLAIM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POLICYCLAIM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POLICYCLAIM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POLICYCLAIM actions', async () => {
      const arg = 42666;
