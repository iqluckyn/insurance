...
/**
 * REST controller for managing {@link com.iql.policyadmin.domain.Season}.
 */
@RestController
...
public class SeasonResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<SeasonDTO>> getAllSeasons(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
